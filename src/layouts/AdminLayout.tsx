...
import { LayoutDashboard, Users, Dumbbell, Utensils, BookOpen } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/admin/exercises', icon: Dumbbell, label: 'Exercise Library', color: 'text-orange-400', bg: 'bg-orange-500/20' },
